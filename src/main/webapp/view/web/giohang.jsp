			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<form action="timkiemController" method="post"
					...
					<a class="btn btn-success btn-sm ml-3" href="show"> <i
						...
						class="badge badge-light">${stt}</span>
					</a>
				</form>
			</div>
		</div>
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th scope="col" class="border-0 bg-light">
													<div class="p-2 px-3 text-uppercase">Mã sữa</div>
												</th>
												<th scope="col" class="border-0 bg-light">
													<div class="py-2 text-uppercase">Tên sữa</div>
												</th>
												<th scope="col" class="border-0 bg-light">
										...
										<tbody>
												<p style="display: none;"><c:out value="gstt" ></c:out></p>
												<p style="display: none;"><c:out value="demsl" ></c:out></p>
												...
												<tr>
													...
													<td><input type="number" min="0"
														...
														<button type="submit" name="butsua"
															value="${h.getMasua()}">Update</button>
														<button type="submit" name="butxoa"
															value="${h.getMasua()}">Delete</button></td>
							...
							<div class="p-4">
								<ul class="list-unstyled mb-4">
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">Tổng tiền hàng</strong><strong>${tongtien}
											vnđ</strong></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
									...
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										...
										<h5 class="font-weight-bold">${tongtien-gantt} vnđ</h5>
									</li>
								</ul>
								<a href="dathangController" class="btn btn-dark rounded-pill py-2 btn-block">Mua
									hàng</a>
							</div>
						</div>
					</div>
