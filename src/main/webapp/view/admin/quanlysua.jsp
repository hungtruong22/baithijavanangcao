                    ...
                    <tbody>
                        <c:forEach items="${dstrang}" var="s">
                            <tr>
                                ...
                                <td>${s.ngaynhap} </td>
                                <td>
                                    <a href="suaController?masua=${s.masua}"  class="edit" data-toggle="modal">
                                    <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="xoaController?masua=${s.masua}" class="delete" data-toggle="modal">
			                    ...
			                    <form action="themController" method="post">
			                        ...
			                        <div class="modal-body">
			                        	<div class="form-group">
			                                ...
			                                <input name="mahang" type="text" class="form-control" required>
			                            </div>					
			                            <div class="form-group">
			                            ...
			                            <div class="form-group">
			                                ...
			                                <input name="slhang" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Giá</label>
			                                <input name="giahang" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Ảnh</label>
			                                <input name="anhhang" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Thông tin chi tiết</label>
			                                <textarea name="thongtinhang" class="form-control" required></textarea>
			                            </div>
			                            <div class="form-group">
			                                <label>Loại mặt hàng</label>
			                                <textarea name="loaihang" class="form-control" required></textarea>
			                            </div>
			                            <div class="form-group">
			                                <label>Tên NCC</label>
			                                <textarea name="tenncchang" class="form-control" required></textarea>
			                            </div>                            
			                            <div class="form-group">
			                                <label>Ngày Nhập</label>
			                                <textarea name="ngaynhaphang" class="form-control" required></textarea>
			                            </div>
			                ...
			                <div class="modal-content">
			                    <form action="editController" method="post">
			                        ...
			                        <div class="modal-body">
			                        	<div class="form-group">
			                                <label>Mã mặt hàng</label>
			                                <input name="mamh" value="${milk.masua}" type="text" class="form-control" readonly required>
			                            </div>					
			                            <div class="form-group">
			                                <label>Tên mặt hàng</label>
			                                <input name="tenmh" value="${milk.tensua}" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Số lượng</label>
			                                <input name="slmh" value="${milk.soluong}" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Giá</label>
			                                <input name="giamh" value="${milk.gia}" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Ảnh</label>
			                                <input name="anhmh" value="${milk.anh}" type="text" class="form-control" required>
			                            </div>
			                            <div class="form-group">
			                                <label>Thông tin chi tiết</label>
			                                <textarea name="ttmh" type="text" class="form-control" required>${milk.thongtin}</textarea>
			                            </div>
			                            <div class="form-group">
			                                <label>Loại mặt hàng</label>
			                                <input name="loaimh" value="${milk.maloai}" type="text" class="form-control" required>
			                            </div>	
			                            <div class="form-group">
			                                <label>Tên NCC</label>
			                                <input name="tennccmh" value="${milk.tenncc}" type="text" class="form-control" required>
			                            </div>					
			                        </div>
			                        <div class="modal-footer">
			                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
