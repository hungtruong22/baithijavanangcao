...
/**
 * Servlet implementation class quanlysuaController
 */
@WebServlet("/quanlysuaController")
public class quanlysuaController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public quanlysuaController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("dn") == null)
			...
			RequestDispatcher rd = request.getRequestDispatcher("./view/admin/quanlysua.jsp");
